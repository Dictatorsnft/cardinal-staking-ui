...
function Home() {
    ...
    const txs: (Transaction | null)[] = await Promise.all(
      tokensToUnstake.map(async (token) => {
        try {
          ...
          notify({
            message: `${e}`,
            description: `Failed to unstake Dictator ${token?.stakeEntry?.pubkey.toString()}`,
            type: 'error',
          })
          return null
        }
  ...
  async function handleStake(all?: boolean) {
    ...
    if (tokensToStake.length <= 0) {
      notify({ message: `No Dictator Selected`, type: 'error' })
      return
    }
  ...
  return (
    ...
    >
      <Head>
        <title>Send your Dictator to Citadel.</title>
        <meta name="description" content="Powered by NUKEDAO" />
                                  ...
                                  <div>
                                    <div className="absolute top-0 left-0 z-10 flex h-full w-full justify-center rounded-xl bg-black bg-opacity-80 align-middle text-white">
                                      <div className="my-auto flex">
                                        ...
                                        Sending Your Dictator To Citadel...
                                      </div>
                                    </div>
                                  </div>
                                )}
              ...
              <div className="flex gap-5">
                <MouseoverTooltip title="Click on tokens to select them">
                  ...
                  >
                    ...
                    <span className="my-auto">
                      Send To Citadel ({unstakedSelected.length})
                    </span>
                  </button>
                </MouseoverTooltip>
                <MouseoverTooltip title="Attempt to stake all tokens at once">
                  ...
                  >
                    ...
                    <span className="my-auto">Send All</span>
                  </button>
                </MouseoverTooltip>
              </div>
            </div>
            ...
            <div className="my-3 flex-auto overflow-auto">
              ...
              >
                {!stakedTokenDatas.isFetched ? (
                  ...
                  >
                    You have no Dictator in Citadel.
                  </p>
                ) : (
                  <div
                    className={
              ...
              <div className="flex gap-5">
                ...
                >
                  ...
                  >
                    ...
                    <span className="my-auto">
                      Callback Your Dictator ({stakedSelected.length})
                    </span>
                  </button>
                </MouseoverTooltip>
                <MouseoverTooltip title="Attempt to unstake all tokens at once">
                  ...
                  >
                    ...
                    <span className="my-auto">Callback All</span>
                  </button>
                </MouseoverTooltip>
              </div>
              <div className="flex gap-5">
                {rewardDistributorData.data &&
                  rewards.data?.claimableRewards.gt(new BN(0)) && (
                    ...
                    >
                      ...
                      <span className="my-auto">
                        Claim $NUKE ({stakedSelected.length})
                      </span>
                    </button>
                  )}
                {rewardDistributorData.data &&
                  ...
                  stakedTokenDatas.data && (
                    ...
                    >
                      ...
                      <span className="my-auto">Claim All $NUKEs</span>
                    </button>
                  )}
              </div>
            </div>
